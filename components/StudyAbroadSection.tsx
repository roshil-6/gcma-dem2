...
export default function StudyAbroadSection() {
    ...
    return (
        <section ref={sectionRef} className="py-12 px-4 relative z-10">
                ...
                <div className="bg-white rounded-3xl p-8 md:p-12 border border-gold-metallic/40 shadow-xl flex flex-col md:flex-row items-center gap-8">
                    <div className="flex-1 space-y-6">
                        ...
                        <p className="text-lg text-[#6d5a3a] leading-relaxed">
                            Access premier universities globally. We provide a comprehensive step-by-step guidance system designed to make your journey seamless, from initial consultation to pre-departure support.
                        </p>
                        <Link href="/study-abroad" className="inline-flex items-center gap-2 bg-gold-metallic hover:bg-[#b8860b] text-black font-semibold py-3 px-8 rounded-xl transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5">
                    ...
                    <div className="flex-1 w-full">
                        <div className="relative w-full aspect-[4/3] rounded-2xl overflow-hidden shadow-lg border-2 border-gold-metallic/20">
                            <Image
                                src="/study-abroad/pexels-3184360.jpg"
                                alt="Study Abroad"
                                fill
